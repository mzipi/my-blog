import { getSortedPostsData } from "../lib/db-connection";
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    <div className="grid md:grid-cols-2 gap-8">
                        {posts.map(({ _id, post }) => {
                            return (
                                <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12" key={_id}>
                                    ...
                                    <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">{post}</p>
