        ...
        <form onSubmit={submitForm} className="py-8 px-4 mx-96 lg:py-16">
            <div className="border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 ">
                <div className="px-3 py-2 border-b dark:border-gray-600">
                    ...
                    <div id="tooltip-fullscreen" role="tooltip" className="absolute inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                        Show full screen
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea id="editor" rows="8" className="w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                </div>
            </div>
